...
async function api(endpoint, options = {}) {
  ...
  try {
    ...
    // Only add headers and body for methods that need them
...
export const products = {
  ...
  update: (data) => api('products', { method: 'PUT', body: data }),
...
export const customers = {
  ...
  update: (data) => api('customers', { method: 'PUT', body: data }),
  delete: (id) => api('customers', { method: 'DELETE', url: `?id=${id}` })
};
...
export const sales = {
  ...
  delete: (id) => api('sales', { method: 'DELETE', url: `?id=${id}` })
};
...
export const suppliers = {
  ...
  update: (data) => api('suppliers', { method: 'PUT', body: data }),
  delete: (id) => api('suppliers', { method: 'DELETE', url: `?id=${id}` })
};
...
export const categories = {
  ...
  update: (data) => api('categories', { method: 'PUT', body: data }),
...
export const settings = {
  ...
  save: (data) => api('settings', { method: 'PUT', body: data }),
  update: (data) => api('settings', { method: 'PUT', body: data })
};
...
export const users = {
  ...
  update: (data) => api('users', { method: 'PUT', body: data }),
  delete: (id) => api('users', { method: 'DELETE', url: `?id=${id}` })
};
