...
const DEMO = {
  products: [
    {id:'P-00001',name:'মিনিকেট চাল',company:'মিনিকেট রাইস',barcode:'001',cat:'খাদ্যপণ্য',buyP:55,sellP:65,stock:100,unit:'কেজি',minStock:10},
    {id:'P-00002',name:'ব্রিলিয়ান্ট চাল',company:'ব্রিলিয়ান্ট',barcode:'002',cat:'খাদ্যপণ্য',buyP:52,sellP:62,stock:80,unit:'কেজি',minStock:10},
    {id:'P-00003',name:'সিআরআরএস চাল',company:'সিআরআরএস',barcode:'003',cat:'খাদ্যপণ্য',buyP:48,sellP:58,stock:120,unit:'কেজি',minStock:10},
    {id:'P-00004',name:'মসুর ডাল',company:'এসআর ফুডস',barcode:'004',cat:'খাদ্যপণ্য',buyP:90,sellP:110,stock:50,unit:'কেজি',minStock:5},
    {id:'P-00005',name:'সয়াবিন তেল ৫লিটার',company:'প্রিমিয়াম অয়েল',barcode:'005',cat:'তেল',buyP:680,sellP:780,stock:30,unit:'লিটার',minStock:5},
    {id:'P-00006',name:'সয়াবিন তেল ১লিটার',company:'প্রিমিয়াম অয়েল',barcode:'006',cat:'তেল',buyP:145,sellP:175,stock:80,unit:'লিটার',minStock:10},
    {id:'P-00007',name:'চিনি',company:'এসআর সুগার',barcode:'007',cat:'খাদ্যপণ্য',buyP:115,sellP:130,stock:60,unit:'কেজি',minStock:10},
    {id:'P-00008',name:'আটা',company:'এসআর অ্যাটা',barcode:'008',cat:'খাদ্যপণ্য',buyP:38,sellP:48,stock:80,unit:'কেজি',minStock:10},
    {id:'P-00009',name:'লবণ',company:'আয়োডিন সল্ট',barcode:'009',cat:'মশলা',buyP:18,sellP:25,stock:100,unit:'কেজি',minStock:10},
    {id:'P-00010',name:'হলুদ গুড়া',company:'এসআর মসলা',barcode:'010',cat:'মশলা',buyP:140,sellP:180,stock:40,unit:'কেজি',minStock:5},
    {id:'P-00011',name:'মরিচ গুড়া',company:'এসআর মসলা',barcode:'011',cat:'মশলা',buyP:200,sellP:250,stock:30,unit:'কেজি',minStock:3},
    {id:'P-00012',name:'বিস্কুট সুগার',company:'এসবি ফুডস',barcode:'012',cat:'স্ন্যাকস',buyP:35,sellP:45,stock:200,unit:'পিস',minStock:20},
    {id:'P-00013',name:'বিস্কুট গোল্ড',company:'এসবি ফুডস',barcode:'013',cat:'স্ন্যাকস',buyP:40,sellP:55,stock:180,unit:'পিস',minStock:20},
    {id:'P-00014',name:'চকলেট ডার্ক',company:'ক্যাডবেরি',barcode:'014',cat:'স্ন্যাকস',buyP:60,sellP:80,stock:100,unit:'পিস',minStock:10},
    {id:'P-00015',name:'চিপস লবণ',company:'প্রিঙ্গলস',barcode:'015',cat:'স্ন্যাকস',buyP:80,sellP:100,stock:120,unit:'পিস',minStock:15},
    {id:'P-00016',name:'নুডলস মগর',company:'মগর',barcode:'016',cat:'স্ন্যাকস',buyP:35,sellP:48,stock:200,unit:'পিস',minStock:20},
    {id:'P-00017',name:'চা ব্যাগ',company:'লিপটন',barcode:'017',cat:'পানীয়',buyP:120,sellP:162,stock:70,unit:'পিস',minStock:10},
    {id:'P-00018',name:'কফি ইনস্ট্যান্ট',company:'নেসকে',barcode:'018',cat:'পানীয়',buyP:150,sellP:195,stock:50,unit:'গ্রাম',minStock:10},
    {id:'P-00019',name:'মিল্ক পাউডার ১কেজি',company:'ডানোন',barcode:'019',cat:'দুধ',buyP:450,sellP:550,stock:30,unit:'কেজি',minStock:5},
    {id:'P-00020',name:'ফ্লেভার্ড মিল্ক',company:'আইসম',barcode:'020',cat:'দুধ',buyP:30,sellP:42,stock:150,unit:'পিস',minStock:20},
    {id:'P-00021',name:'আইসক্রিম কাপ',company:'মিনিমুটস',barcode:'021',cat:'আইসক্রিম',buyP:35,sellP:48,stock:100,unit:'পিস',minStock:15},
    {id:'P-00022',name:'সফট ড্রিংকস',company:'কোকাকোলা',barcode:'022',cat:'পানীয়',buyP:20,sellP:30,stock:300,unit:'পিস',minStock:30},
    {id:'P-00023',name:'জুস আপেল',company:'প্রিজ',barcode:'023',cat:'পানীয়',buyP:45,sellP:62,stock:120,unit:'পিস',minStock:15},
    {id:'P-00024',name:'মিনারেল ওয়াটার',company:'এপি ফিল্টার্ড',barcode:'024',cat:'পানীয়',buyP:15,sellP:22,stock:400,unit:'পিস',minStock:50},
    {id:'P-00025',name:'এনার্জি ড্রিংক',company:'রেডবুল',barcode:'025',cat:'পানীয়',buyP:90,sellP:120,stock:80,unit:'পিস',minStock:10},
    {id:'P-00026',name:'আলু',company:'স্থানীয়',barcode:'026',cat:'সবজি',buyP:25,sellP:35,stock:200,unit:'কেজি',minStock:20},
    {id:'P-00027',name:'পটল',company:'স্থানীয়',barcode:'027',cat:'সবজি',buyP:40,sellP:55,stock:100,unit:'কেজি',minStock:15},
    {id:'P-00028',name:'বেগুন',company:'স্থানীয়',barcode:'028',cat:'সবজি',buyP:35,sellP:48,stock:90,unit:'কেজি',minStock:15},
    {id:'P-00029',name:'টমেটো',company:'স্থানীয়',barcode:'029',cat:'সবজি',buyP:45,sellP:62,stock:120,unit:'কেজি',minStock:15},
    {id:'P-00030',name:'পিয়াজ',company:'স্থানীয়',barcode:'030',cat:'সবজি',buyP:30,sellP:42,stock:150,unit:'কেজি',minStock:20},
    {id:'P-00031',name:'আম',company:'স্থানীয়',barcode:'031',cat:'ফল',buyP:80,sellP:108,stock:100,unit:'কেজি',minStock:15},
    {id:'P-00032',name:'কলা',company:'স্থানীয়',barcode:'032',cat:'ফল',buyP:15,sellP:22,stock:300,unit:'পিস',minStock:30},
    {id:'P-00033',name:'পেয়ারা',company:'স্থানীয়',barcode:'033',cat:'ফল',buyP:35,sellP:48,stock:120,unit:'পিস',minStock:15},
    {id:'P-00034',name:'মুরগি (ব্রয়লার)',company:'ফার্মা',barcode:'034',cat:'মুরগি',buyP:120,sellP:155,stock:40,unit:'পিস',minStock:10},
    {id:'P-00035',name:'ডিম (মুরগি)',company:'ফার্মা',barcode:'035',cat:'ডিম',buyP:10,sellP:14,stock:500,unit:'পিস',minStock:50},
    {id:'P-00036',name:'ইলিশ মাছ',company:'স্থানীয়',barcode:'036',cat:'মাছ',buyP:800,sellP:1000,stock:5,unit:'কেজি',minStock:1},
    {id:'P-00037',name:'রুই মাছ',company:'স্থানীয়',barcode:'037',cat:'মাছ',buyP:350,sellP:450,stock:8,unit:'কেজি',minStock:2},
    {id:'P-00038',name:'গরুর মাংস',company:'স্থানীয়',barcode:'038',cat:'মাংস',buyP:550,sellP:700,stock:10,unit:'কেজি',minStock:2},
    {id:'P-00039',name:'খাসির মাংস',company:'স্থানীয়',barcode:'039',cat:'মাংস',buyP:480,sellP:620,stock:12,unit:'কেজি',minStock:2},
    {id:'P-00040',name:'চিনি (প্রিমিয়াম)',company:'মিঠাই',barcode:'040',cat:'খাদ্যপণ্য',buyP:125,sellP:145,stock:50,unit:'কেজি',minStock:10},
    {id:'P-00041',name:'পারফেক্ট চাল',company:'পারফেক্ট',barcode:'041',cat:'খাদ্যপণ্য',buyP:50,sellP:60,stock:90,unit:'কেজি',minStock:10},
    {id:'P-00042',name:'সরিষার তেল ১লিটার',company:'ন্যাচারাল প্রেস',barcode:'042',cat:'তেল',buyP:180,sellP:220,stock:40,unit:'লিটার',minStock:5},
    {id:'P-00043',name:'ভোজ্যতেল ৫লিটার',company:'ফ্রেশ অয়েল',barcode:'043',cat:'তেল',buyP:750,sellP:920,stock:25,unit:'লিটার',minStock:3},
    {id:'P-00044',name:'গরম মশলা',company:'এসআর মসলা',barcode:'044',cat:'মশলা',buyP:130,sellP:165,stock:30,unit:'কেজি',minStock:3},
    {id:'P-00045',name:'কারি পাউডার',company:'এসআর মসলা',barcode:'045',cat:'মশলা',buyP:150,sellP:190,stock:25,unit:'কেজি',minStock:3},
    {id:'P-00046',name:'টমেটো কেচাপ',company:'হেল্পার',barcode:'046',cat:'সস',buyP:45,sellP:60,stock:80,unit:'পিস',minStock:10},
    {id:'P-00047',name:'সয়া সস',company:'হেল্পার',barcode:'047',cat:'সস',buyP:65,sellP:85,stock:70,unit:'মিলি',minStock:10},
    {id:'P-00048',name:'পাঠান চাউল',company:'পাঠান',barcode:'048',cat:'খাদ্যপণ্য',buyP:75,sellP:95,stock:60,unit:'কেজি',minStock:10},
    {id:'P-00049',name:'বাসমতি চাউল',company:'বাসমতি',barcode:'049',cat:'খাদ্যপণ্য',buyP:150,sellP:190,stock:40,unit:'কেজি',minStock:5},
    {id:'P-00050',name:'মধু',company:'মধু ফার্ম',barcode:'050',cat:'খাদ্যপণ্য',buyP:250,sellP:338,stock:40,unit:'গ্রাম',minStock:5},
  ],
  customers: [
