...
export default function App() {
  ...
  return (
    <>
      <GlobalStyle />
      <div style={{display:'flex',flexDirection:'column',height:'100vh',width:'100%',background:T.gray50,fontFamily:'BanglaFont, EnglishFont, "Segoe UI", system-ui, sans-serif',color:T.gray900,overflow:'hidden'}}>
      {/* Header */}
