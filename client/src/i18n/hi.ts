export const hi: Record<string, string> = {
  ...
  stockExistsCannotDelete: 'स्टॉक वाले उत्पाद को हटाया नहीं जा सकता',
  ...
  noProductsAdded: 'कोई उत्पाद नहीं जोड़ा गया',
  csvImport: 'CSV आयात करें',
  uploadProductCSV: 'उत्पाद CSV अपलोड करें',
  downloadDemoCSV: 'डेमो CSV डाउनलोड करें',
  productsUploaded: 'उत्पाद अपलोड किए गए',
  csvError: 'CSV फाइल में हेडर और कम से कम एक उत्पाद होना चाहिए',
  uploadFailed: 'अपलोड विफल!',
  productsNotFound: 'कोई उत्पाद नहीं मिला। CSV प्रारूप सही नहीं है।',
  supplierNotInDB: 'आपूर्तिकर्ता डेटाबेस में नहीं',
  categoryNotInDB: 'श्रेणी डेटाबेस में नहीं',
