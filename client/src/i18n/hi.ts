export const hi: Record<string, string> = {
  ...
  info1: 'डेटा सर्वर डेटाबेस में सेव है',
  ...
  offlinePageBody: 'ऐप बिना इंटरनेट के पिछला डेटा दिखा सकता है। कनेक्शन वापस आने पर रीलोड करें।',
  offlinePageTitle: 'इंटरनेट कनेक्शन नहीं है',
  ...
  autoLogout5min: '5 मिनट निष्क्रिय — स्वतः लॉगआउट',
  cancel: 'रद्द करें',
  closeButton: 'बंद करें',
  company: 'कंपनी',
  confirmDelete: 'हटाने की पुष्टि करें?',
  confirmDeleteCat: 'क्या आप इस श्रेणी को हटाना चाहते हैं?',
  duplicateNameCat: 'श्रेणी का नाम पहले से मौजूद है',
  productsUncat: 'इस श्रेणी के उत्पाद बिना श्रेणी के हो जाएँगे',
  delete: 'हटाएं',
  print: 'प्रिंट',
  ...
  addProductDesc: 'विवरण भरें, लाइव पूर्वावलोकन देखें, फिर सूची में जोड़ें',
  livePreview: 'लाइव पूर्वावलोकन',
  basicInfo: 'मूल जानकारी',
  pricingInfo: 'मूल्य निर्धारण',
  inventoryInfo: 'इन्वेंटरी',
  formProgress: 'फ़ॉर्म प्रगति',
  ...
  allStockBarcodeHint: 'बारकोड लेबल प्रिंट = स्टॉक मात्रा',
  manualCountBarcodeHint: 'प्रॉम्पट: N बारकोड लेबल प्रिंट करें',
...
printBlocked: 'प्रिंट विंडो ब्लॉक है! रसीद प्रिंट करने के लिए पॉपअप की अनुमति दें।',
  ...
  generateBarcodes: 'बारकोड बनाएँ',
  popupBlocked: 'पॉप-अप ब्लॉक हुआ। प्रिंट करने के लिए पॉप-अप की अनुमति दें।',
  printUnsupported: "इस ब्राउज़र में अपने-आप प्रिंट नहीं हो सकता। लेबल नए टैब में खुले हैं - छापने के लिए शेयर > प्रिंट उपयोग करें।",
  deselectPurchase: 'खरीद चयन रद्द करें',
  barcodeTooSmall: 'बारकोड स्कैन करने के लिए बहुत छोटा है — छोटा बारकोड कोड उपयोग करें।',
  barcodeTooSmallA4: 'इस A4 लेबल पर बारकोड बहुत छोटा है — लेबल कागज़ को रोल 58/80 मिमी करें।',
  ...
  choosePurchase: 'खरीद चुनें',
  missingBarcode: 'बारकोड उपलब्ध नहीं',
  maxLabels: 'प्रति प्रिंट अधिकतम 500 लेबल',
  ...
  dataSavedLocally: 'डेटा सर्वर डेटाबेस में सहेजा जाता है',
