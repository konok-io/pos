export const ar: Record<string, string> = {
  ...
  localDatabase: 'قاعدة بيانات الخادم',
  ...
  howItWorks: 'كيف يعمل',
  info1: 'البيانات محفوظة في قاعدة بيانات الخادم',
  ...
  confirmDeleteCat: 'هل أنت متأكد من حذف هذه الفئة؟',
  duplicateNameCat: 'اسم الفئة موجود بالفعل',
  productsUncat: 'ستصبح المنتجات في هذه الفئة بلا فئة',
  delete: 'حذف',
  print: 'طباعة',
...
printBlocked: 'تم حظر نافذة الطباعة! اسمح بالنوافذ المنبثقة لطباعة الإيصال.',
  ...
  generateBarcodes: 'إنشاء الباركود',
  popupBlocked: 'تم حظر النافذة المنبثقة. يرجى السماح بها للطباعة.',
  printUnsupported: "لا يمكن لهذا المتصفح الطباعة تلقائيًا. الملصقات مفتوحة في تبويب جديد - استخدم مشاركة ثم الطباعة.",
  deselectPurchase: 'إلغاء تحديد الفاتورة',
  barcodeTooSmall: 'الباركود صغير جدًا لمسحه بشكل موثوق — استخدم رمزًا أقصر',
  barcodeTooSmallA4: 'الباركود صغير جدًا على هذا الملصق A4 — بدّل ورق الملصق إلى رول 58/80 مم',
  ...
  choosePurchase: 'اختر عملية الشراء',
  missingBarcode: 'الباركود مفقود',
  maxLabels: 'بحد أقصى 500 ملصق لكل طباعة',
  ...
  dataSavedLocally: 'البيانات محفوظة في قاعدة بيانات الخادم',
