export const bn: Record<string, string> = {
  ...
  info1: 'ডাটা সার্ভার ডাটাবেসে সেভ থাকে',
  ...
  offlinePageBody: 'অ্যাপটি অফলাইনেও পূর্ববর্তী ডেটা দেখাতে পারে। সংযোগ ফিরলে রিলোড করুন।',
  offlinePageTitle: 'ইন্টারনেট সংযোগ নেই',
  ...
  autoLogout5min: '৫ মিনিট নিষ্ক্রিয় — অটো লগআউট হয়েছে',
  cancel: 'বাতিল',
  closeButton: 'বন্ধ করুন',
  company: 'কোম্পানি',
  confirmDelete: 'মুছে ফেলতে নিশ্চিত করুন?',
  confirmDeleteCat: 'আপনি কি এই ক্যাটাগরি মুছে ফেলতে চান?',
  duplicateNameCat: 'ক্যাটাগরির নাম আগে থেকেই আছে',
  productsUncat: 'এই ক্যাটাগরির প্রোডাক্টগুলো ক্যাটাগরিছাড়া হয়ে যাবে',
  delete: 'মুছুন',
  print: 'প্রিন্ট',
  ...
  addProductDesc: 'তথ্য পূরণ করুন, লাইভ প্রিভিউ দেখুন, তারপর তালিকায় যোগ করুন',
  livePreview: 'লাইভ প্রিভিউ',
  basicInfo: 'মৌলিক তথ্য',
  pricingInfo: 'মূল্য',
  inventoryInfo: 'ইনভেন্টরি',
  formProgress: 'ফর্ম অগ্রগতি',
  ...
  totalIn: 'মোট যাবে',
  invalid: 'ভুল মান',
  clearAll: 'লিস্ট থেকে সব প্রোডাক্ট মুছবেন?',
  stockMerged: 'মৌজুদা লিস্ট আইটেমে স্টক যোগ হয়েছে',
  posting: 'পোস্ট হচ্ছে...',
  clearCartConfirm: 'কার্ট পরিষ্কার করবেন?',
  totalChanges: 'মোট পরিবর্তন',
  priceUp: 'দাম বৃদ্ধি',
  priceDown: 'দাম কমেছে',
  avgChange: 'গড় পরিবর্তন',
  ...
  copies: 'কপি',
  allStockBarcode: 'অল স্টক বারকোড',
  manualCountBarcode: 'ম্যানুয়াল কাউন্ট বারকোড',
  allStockBarcodeHint: 'প্রোডাক্টের স্টক অনুযায়ী বারকোড লেবেল প্রিন্ট',
  manualCountBarcodeHint: 'প্রম্পট: N টি বারকোড লেবেল প্রিন্ট',
...
printBlocked: 'প্রিন্ট উইন্ডো ব্লক হয়েছে! রিসিট প্রিন্ট করতে পপ-আপ অনুমোদন দিন।',
  ...
  generateBarcodes: 'বারকোড তৈরি করুন',
  popupBlocked: 'পপ-আপ ব্লক করা হয়েছে। প্রিন্ট করতে পপ-আপ অনুমোদন করুন।',
  printUnsupported: "এই ব্রাউজারে স্বয়ংক্রিয় প্রিন্ট করা যায় না। নতুন ট্যাবে লেবেলগুলো খোলা আছে - প্রিন্ট করতে Share > Print ব্যবহার করুন।",
  deselectPurchase: 'পারচেজ নির্বাচন বাতিল',
  barcodeTooSmall: 'স্ক্যান করতে বারকোড খুব ছোট — ছোট বারকোড কোড ব্যবহার করুন।',
  barcodeTooSmallA4: 'এই A4 লেবেলে বারকোড খুব ছোট — লেবেল কাগজ Roll 58/80 mm করুন।',
  ...
  choosePurchase: 'পারচেজ নির্বাচন করুন',
  missingBarcode: 'বারকোড নেই',
  maxLabels: 'প্রতি প্রিন্টে সর্বোচ্চ ৫০০টি লেবেল',
  ...
  dataSavedLocally: 'ডাটা সার্ভার ডাটাবেসে সেভ থাকে',
