export const bn: Record<string, string> = {
  ...
  purchasePriceLabel: 'ক্রয়মূল্য (৳)',
  sellPriceLabel: 'বিক্রয়মূল্য (৳)',
  minStock: 'মিনিমাম স্টক',
  profit: 'লাভ',
  profitPercent: 'লাভ (%)',
  supplier: 'সরবরাহকারী',
  company: 'কোম্পানি',
  stockAvailableShort: 'স্টক আছে',
  stockOutShort: 'স্টক শেষ',
  ...
  confirmDelete: 'পণ্যটি মুছে ফেলতে চান?',
  stockExistsCannotDelete: 'স্টক থাকলে মুছা যাবে না',
  productNameLabel: 'পণ্যের নাম *',
  barcodeLabel: 'বারকোড',
  unitLabel: 'একক',
  stockLabel: 'স্টক',
  addToProductList: 'পণ্য তালিকায় যোগ করুন',
  productListNew: 'পণ্যের তালিকা',
  saveAll: 'সব সংরক্ষণ',
  noProductsAdded: 'কোনো পণ্য যোগ করা হয়নি',
  csvImport: 'CSV ইম্পোর্ট করুন',
  uploadProductCSV: 'পণ্যের CSV আপলোড করুন',
  downloadDemoCSV: 'ডেমো CSV ডাউনলোড',
  productsUploaded: 'টি পণ্য আপলোড হয়েছে',
  csvError: 'CSV ফাইলে কমপক্ষে হেডার ও একটি পণ্য থাকতে হবে',
