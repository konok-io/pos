export const en: Record<string, string> = {
  ...
  duplicateNameCat: 'Category name already exists',
  productsUncat: 'Products in this category will become uncategorized',
  ...
  info1: 'Data is stored in the server database',
  ...
  offlinePageBody: 'The app can show previous data offline. Reload when the connection is back.',
  offlinePageTitle: 'No internet connection',
  ...
  autoLogout5min: 'Inactive 5 min — auto logged out',
  ...
  addProductDesc: 'Fill in details, preview live, then add to list',
  ...
  stockMerged: 'Stock merged into existing list item',
  posting: 'Posting...',
  ...
  copies: 'Copies',
  allStockBarcode: 'All Stock Barcode',
  manualCountBarcode: 'Manual Count Barcode',
  allStockBarcodeHint: 'Print barcode labels = product stock qty',
  manualCountBarcodeHint: 'Prompt: print N barcode labels',
...
printBlocked: 'Print window blocked! Allow popups to print receipt.',
  ...
  enterStock: 'Enter paid or free quantity',
  ...
  clearDeleteHistoryConfirm: "Clear the deleted products history? This cannot be undone.",
  ...
  popupBlocked: 'Pop-up blocked. Please allow pop-ups for this site to print.',
  printUnsupported: "This browser cannot print automatically. The labels are open in a new tab - use Share > Print to print them.",
  deselectPurchase: 'Deselect Purchase',
  barcodeTooSmall: 'Barcode is too small to scan reliably - use a shorter barcode code',
  barcodeTooSmallA4: 'Barcode is too small on this A4 label - switch the label paper to Roll 58/80 mm',
  searchPurchaseId: 'Search Purchase ID',
  labels: 'Labels',
  ...
  choosePurchase: 'Choose Purchase',
  missingBarcode: 'Missing Barcode',
  maxLabels: 'Maximum 500 labels per print',
  ...
  dataSavedLocally: 'Data is saved in the server database',
