...
import {
  faBox, faXmark, faTriangleExclamation, faBuilding, faCheckCircle, faPlus, faTrash,
  ...
  faChevronRight, faUndo, faBan, faMugHot, faGlassWater, faBowlRice, faBowlFood,
  faDrumstickBite, faAppleWhole, faLeaf, faFish, faBreadSlice,
  ...
  faThumbtack, faUserTie, faCalendarCheck, faBell, faIdCard, faPills, faCookie
...
const MAP: Record<string, IconDefinition> = {
  ...
  '🐟': faFish, '🫓': faBreadSlice, '🧼': faPumpSoap, '🪥': faPumpSoap, '💊': faPills, '🍪': faCookie,
  ...
  '📆': faCalendarCheck, '🔔': faBell, '🪪': faIdCard, '✉️': faEnvelope,
};
