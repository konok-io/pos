      ...
      <div style={{ background: '#FFFFFF', padding: '0 24px', flexShrink: 0, boxShadow: '0 4px 20px rgba(0,0,0,0.08)', borderBottom: '2px solid #115E59' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, flexShrink: 0 }}>
            ...
            <div>
              <div style={{ fontWeight: 800, fontSize: 18, color: '#115E59', lineHeight: 1.2 }}>{t('posManagementSystem')}</div>
              <div style={{ fontSize: 12, color: '#9CA3AF' }}>{t('smartBusinessPartner')}</div>
            </div>
          </div>
